...
const ModalEditPembayaran = ({
  ...
  const [formPembayaran, setFormPembayaran] = useState({
    id_rumah: dataUpdate.id_rumah || "",
    id_penghuni: dataUpdate.id_penghuni || "",
    jumlah_pembayaran: dataUpdate.jumlah_pembayaran || (0 as any),
    jenis_iuran: dataUpdate.jenis_iuran || "",
    status_pembayaran: dataUpdate.status_pembayaran || "",
    tanggal_pembayaran: dataUpdate.tanggal_pembayaran || "",
    bulan_bayar: dataUpdate.bulan_bayar || "",
  });

  const handleEditPembayaran = async (e: any) => {
    e.preventDefault();
    try {
      const res = await pembayaranServices.updatePembayaran(
        dataUpdate.id,
        formPembayaran,
      );
      if (res.status === 200) {
        ...
        setDataUpdate([]);
        toast.success("Pembayaran  berhasil di edit");
      }
      setShowModalEdit(false);
    } catch (error: any) {
              ...
              <div className="p-6.5">
                ...
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                  <div className="w-full">
                    ...
                    <input
                      defaultValue={formPembayaran.tanggal_pembayaran}
                      onChange={(e) =>
                        setFormPembayaran({
                          ...formPembayaran,
                ...
                <button
                  type="submit"
                  onClick={(e) => handleEditPembayaran(e)}
